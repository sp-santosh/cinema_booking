...
-- 1. Roles
REPLACE INTO roles (role_id, role_name) VALUES 
(1, 'Admin'),
(2, 'Customer')
...
REPLACE INTO users (user_id, role_id, first_name, last_name, email, password_hash, phone) VALUES 
...
-- 3. Cinemas
REPLACE INTO cinemas (cinema_id, name, address_line1, city, postcode) VALUES 
(1, 'CineBook Central Skyline', '123 Entertainment Way', 'London', 'WC2H 7LT'),
(2, 'CineBook Marina', '45 Ocean Drive', 'Brighton', 'BN2 1TW');

-- 4. Halls (Screens)
REPLACE INTO halls (hall_id, cinema_id, name) VALUES 
(1, 1, 'Screen 1 - IMAX'),
...
REPLACE INTO seats (hall_id, row_label, seat_number) VALUES 
...
-- 6. Movies
REPLACE INTO movies (movie_id, title, duration_minutes, age_rating, movie_rating, description) VALUES 
...
REPLACE INTO screenings (screening_id, movie_id, hall_id, start_time, end_time, status) VALUES 
...
(4, 1, 3, DATE_ADD(NOW(), INTERVAL 2 DAY), DATE_ADD(NOW(), INTERVAL '2 03:00' DAY_MINUTE), 'SCHEDULED'), -- Dune in Brighton
...
REPLACE INTO bookings (booking_id, customer_id, screening_id, status, total_amount) VALUES 
...
REPLACE INTO tickets (ticket_id, booking_id, screening_id, seat_id, price) VALUES 
(1, 1, 1, 1, 12.50),
(2, 1, 1, 2, 12.50),
(3, 2, 2, 16, 12.50); -- Jane booked Hall 2, Seat A1 (ID 16 based on insertion order)

-- 10. Payments
REPLACE INTO payments (payment_id, booking_id, amount, method, payment_status, paid_at) VALUES 
